export default {
  requirementAnalysis: {
    ...
    downloadFailed: '下载失败',
    // XMind Export
    xmindFileName: 'AI生成测试用例_{taskId}_{date}.xmind',
    xmindTitle: '测试用例 - {taskId}',
    xmindDownloadSuccess: 'XMind导出成功',
    xmindDownloadFailed: 'XMind导出失败',
    noCasesToExport: '没有可导出的测试用例',
  ...
  taskDetail: {
    ...
    xmindFileName: '测试用例_{taskId}_{date}.xmind',
    xmindTitle: '测试用例 - {taskId}',
    xmindExportSuccess: 'XMind导出成功',
    xmindExportFailed: 'XMind导出失败',
