...
export default {
  ...
  interface: {
    ...
    // 脚本
    preRequestScript: '前置脚本 (Python)',
    postRequestScript: '后置脚本 (Python)',
    // 断言
    assertions: '断言',
    addAssertion: '添加断言',
    assertionName: '断言名称',
  ...
  component: {
    ...
    scriptEditor: {
      phasePre: '前置',
      phasePost: '后置',
      toggleHelp: '查看 API 帮助',
      helpVars: '读取/写入变量,写到的变量可在后续请求 {{varName}} 中引用',
      helpRequest: '当前请求快照(method/url/headers/body),只读',
      helpResponse: '响应对象(post 阶段可用,支持 .json() / .text / .headers / .status_code),只读',
      helpLog: '记录日志,可在执行报告里查看',
      helpInjectedTitle: '可直接使用的模块(无需 import)',
      helpExampleTitle: '示例'
    },
    assertionEditor: {
      columnEnable: '启用',
      columnName: '名称',
      columnSource: '来源',
      sourceStatus_code: 'HTTP 状态码',
      sourceResponse_time: '响应时间(ms)',
      sourceJson_body: 'JSON Body (JSONPath)',
      sourceHeader: '响应头',
      sourceRaw_body: '原始响应体',
      columnOperator: '操作符',
      opEquals: '等于 ==',
      opNot_equals: '不等于 !=',
      opContains: '包含',
      ...
      opGreater_than: '大于 >',
      opLess_than: '小于 <',
      opGreater_equal: '大于等于 >=',
      opLess_equal: '小于等于 <=',
      opIn_array: '在数组中',
      opNot_in_array: '不在数组中',
      opRegex: '正则匹配',
      opLength_eq: '长度等于',
      opExists: '存在(非空)',
      opNot_exists: '不存在(空)',
      opType_is: '类型是',
      columnExpression: '表达式 / 路径',
      columnExpected: '期望值',
      columnMessage: '失败提示',
      columnActions: '操作',
      add: '添加断言',
      remove: '删除',
      noData: '暂无断言',
      emptyExpected: '期望值不能为空',
      emptyExpression: '表达式不能为空',
      legacyHint: '此断言是旧格式,保存后将自动转为新格式'
    }
  },
