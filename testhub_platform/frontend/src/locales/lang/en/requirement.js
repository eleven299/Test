export default {
  requirementAnalysis: {
    ...
    // XMind Export
    xmindFileName: 'AI_Generated_TestCases_{taskId}_{date}.xmind',
    xmindTitle: 'Test Cases - {taskId}',
    xmindDownloadSuccess: 'XMind export successful',
    xmindDownloadFailed: 'XMind export failed',
  ...
  taskDetail: {
    ...
    xmindFileName: 'TestCases_{taskId}_{date}.xmind',
    xmindTitle: 'Test Cases - {taskId}',
    xmindExportSuccess: 'XMind export successful',
    xmindExportFailed: 'XMind export failed',
